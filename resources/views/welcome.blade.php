        ...
        <div class="relative min-h-screen">
            @if (Route::has('login'))
                <div class="navbar">
                    <div class="flex items-center">
                        ...
                        <h1 class="ml-4 text-lg font-semibold text-sena-green">SERENA</h1>
                    </div>
            ...
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div class="text-center mb-12">
                    ...
                    <p class="mt-2 text-black-600">Descubre las características de nuestro sistema de gestión para el SENA</p>
                </div>
                ...
                <div class="why-use-section mt-16">
                    <div class="flex flex-col md:flex-row">
                        <div class="md:w-2/3 why-use-content">
